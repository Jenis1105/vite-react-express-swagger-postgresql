...
const Dashboard = () => {
  const user = useSelector((state:RootState) => state.user.user); // get user email from redux store
  const url = useSelector((state:RootState) => state.user.picture); // get user picture from redux store
